...
<body>
	...
	<form name="form1" action="addSysManager" method="post"
...
<!-- 				<td class="tableleft">最后一次登陆时间</td> -->
<!-- 				<td><input type="text" name="man_login" id="login" /> -->
<!-- 				</td> -->
			</tr>
			<br>
			<tr>
				<td width="10%" class="tableleft">密码</td>
				<td><input type="password" name="man_psd" id="password" />
				</td>
				<td width="10%" class="tableleft">确认密码</td>
				<td><input type="password" name="man_psd2" id="password2" />
				</td>
